...
:::note tip この記事で学べること
- Lazygitの基本操作（ステージング、コミット、ブランチ）
- 中級操作（リベース、スカッシュ、チェリーピック）
- コンフリクト解決の実践的なワークフロー
- 便利なショートカットとカスタマイズ方法
:::
...
:::note success Omarchyユーザー向け
Omarchyには**プリインストール**されています。追加のインストールは不要です！そのまま `lazygit` または `lg` コマンドで起動できます。
:::
