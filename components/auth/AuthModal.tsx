            ...
            {mode !== 'reset' && (
              <>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-border hover:bg-muted transition-colors disabled:opacity-50 mt-3"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path
                      fill="currentColor"
