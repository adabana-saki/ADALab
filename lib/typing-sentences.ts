...
const JAPANESE_PROVERBS: TypingSentence[] = [
  ...
  { text: '井の中の蛙大海を知らず', reading: 'inonakanokawazdutaikaiowoshirazu', language: 'ja', category: 'proverb', difficulty: 'normal' },
  { text: '継続は力なり', reading: 'keizokuwachikaranari', language: 'ja', category: 'proverb', difficulty: 'easy' },
  { text: '百聞は一見に如かず', reading: 'hyakubunwaikkenni shikazu', language: 'ja', category: 'proverb', difficulty: 'normal' },
  ...
  { text: '雨降って地固まる', reading: 'amefuttejikatamar', language: 'ja', category: 'proverb', difficulty: 'easy' },
  ...
  { text: '鉄は熱いうちに打て', reading: 'tetsuwatsuiuchiw ute', language: 'ja', category: 'proverb', difficulty: 'easy' },
...
const JAPANESE_DAILY: TypingSentence[] = [
  ...
  { text: 'おつかれさまでした', reading: 'otsukaresama deshita', language: 'ja', category: 'daily', difficulty: 'easy' },
